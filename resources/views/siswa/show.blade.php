                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        <label>Jenis Kelamin</label><br>
                                                            <div class="radio">
                                                                <label>
                                                                    <input type="radio" name="jenis_kelamin" id="optionsRadios1" disabled value="Laki Laki" 
                                                                    {{ $siswa->jenis_kelamin == 'Laki Laki' ? 'checked' : '' }}> Laki Laki
                                                                </label>
                                                            </div>
                                                            <div class="radio">
                                                                <label>
                                                                    <input type="radio" name="jenis_kelamin" disabled id="optionsRadios2" value="Perempuan"

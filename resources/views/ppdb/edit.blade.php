                      ...
                      @method('PUT')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="radio" class="form-check-input" name="jenis_kelamin" value="Laki Laki" 
                                {{ $ppdb->jenis_kelamin == 'Laki Laki' ? 'checked' : '' }}> 
                            ...
                            <input type="radio" class="form-check-input" name="jenis_kelamin" value="Perempuan" style="margin-left: 10px" 
                                {{ $ppdb->jenis_kelamin == 'Perempuan' ? 'checked' : '' }}> 
                        ...
                        <div class="form-group mb-3">
                            <label>Alamat</label>
                            <textarea class="form-control" id="floatingTextarea" name="alamat">{{ $ppdb->alamat }}</textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label>Telepon</label>
